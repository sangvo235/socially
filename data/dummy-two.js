export const DUMMY_TWO_DATA = [
    {id: 1, name: 'Kpop', tags: 'BTS, Blackpink, Twice', description: 'test description KPOP'},
    {id: 2, name: 'Bears', tags: 'Polar Bear, Grizzly Bear, Panda Bear', description: 'test description Bears'},
    {id: 3, name: 'Dogs', description: 'Pomeranian, Husky, Golden Retriever', description: 'test description Dogs'},
